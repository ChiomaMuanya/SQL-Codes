...
--question 4
--Which Territory has the highest sales in the 4th quarter

select "TERRITORY", sum("QUANTITY") as "Total_QTY"
from
(select *, 
 case when "COUNTRIES" in ('Nigeria', 'Ghana') then 'Anglophone'
 else 'Francophone' end as "TERRITORY"
...
from "SalesTable")) as "Table1") as "Table2"
where "QUARTERS" = 'q4'
group by "TERRITORY"
order by "Total_QTY" desc
